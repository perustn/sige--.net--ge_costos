...
Public Class FrmGuiasAsociadas_Hilados_AsigGuias
    ...
    Sub CARGA_MOVIMIENTOS()
        Try
            ...
            strSQL &= vbNewLine & String.Format(",@Previo           = '{0}'", "")
    ...
    Private Sub GridEX_To_GridEX(GridExOrigen As GridEX, GridExDestino As GridEX, oDT_GridEx_Origen As DataTable, oDT_GridEx_Destino As DataTable)
        ...
        If GridExOrigen.RowCount > 0 Then
            ...
            oDT_GridEx_Destino.Rows.Add(sRegistrosAPasar("Movimiento").ToString(), sRegistrosAPasar("Almacen").ToString(), sRegistrosAPasar("Guia").ToString(), sRegistrosAPasar("Fecha").ToString(), sRegistrosAPasar("O/C").ToString(), sRegistrosAPasar("Maquina").ToString(), sRegistrosAPasar("Cantidad").ToString(), sRegistrosAPasar("Total").ToString(), sRegistrosAPasar("COD_ALMACEN").ToString())
        ...
        Try
            ...
            If oDtOPs.Rows.Count > 0 Then
                ...
                For Each dtrow As DataRow In oDtOPs.Rows
                    strSQL = "EXEC HIL_ASIGNAR_GUIA_FACTURA"
