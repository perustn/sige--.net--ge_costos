...
Public Class FrmGuiasAsociadas_PostTejido_AsigGuias
    ...
    Sub CARGA_MOVIMIENTOS()
        Try
            ...
            strSQL = "EXEC Costos_Muestra_Guias_por_Asignar_Post_Tejido_rollo"
    ...
    Private Sub GridEX_To_GridEX(GridExOrigen As GridEX, GridExDestino As GridEX, oDT_GridEx_Origen As DataTable, oDT_GridEx_Destino As DataTable)
        ...
        If GridExOrigen.RowCount > 0 Then
            ...
            oDT_GridEx_Destino.Rows.Add(sRegistrosAPasar("Cod_Almacen").ToString(), sRegistrosAPasar("Movimiento").ToString(), sRegistrosAPasar("Guia").ToString())
        ...
        Try
            ...
            If oDtOPs.Rows.Count > 0 Then
                ...
                For Each dtrow As DataRow In oDtOPs.Rows
                    strSQL = "EXEC Costos_Asigna_Guias_Post_Tejido_rollo"
